...
0.07 is much less than one, so based on my rough estimate the study changed my opinion by $1/0.07=~14$ fold.  Another way to think about this is to compare the **posterior** probabilities of two hypotheses or models ($$BF=\frac{Pr(E|H_1)}{Pr(E|H_2)}$$) a value which is known as the Bayes Factor.
